...
// Next vars are a table of values to manage AI move scoring
...
function MaterialDraw() {
	// Checks if the board position is a draw
...
function EvalPosition() {
	// Evaluates Position of current move, and calculates the score of that move
	var pce;
	var pceNum;
	var sq;
