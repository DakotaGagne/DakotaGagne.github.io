/*------------------------------
	...
	to the board vars and
	board states / changes
...
function BoardToFen() {
	/*
		Converts the Curr Board into a Fen String
	*/
	var fenStr = '';
...
function LineMatch(BookLine,gameline) {
	/*
		Makes sure BookLine matches Gameline
	*/
